...
public class Pyramids {
    ...
    private String pharoah, ancient_name, modern_name, site, material;
    ...
    public Pyramids(String pharoah, String ancient_name, String modern_name, String site, String material) {
        this.pharoah = pharoah;
        this.ancient_name = ancient_name;
        this.modern_name = modern_name;
        this.site = site;
